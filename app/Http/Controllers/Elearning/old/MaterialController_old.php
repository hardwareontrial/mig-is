...
class MaterialController extends Controller
{
    ...
    {
        $this->middleware(['permission:admin all|admin okm|create material okm'])->only(['create']);
        $this->middleware(['permission:admin all|admin okm|update material okm'])->only(['edit']);
    }
    /**
