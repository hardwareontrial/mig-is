    ...
    <div class="card">
        <div class="card-header">
            <div class="row m-b-10">
                <div class="col-sm-12">
                    <a href="{{ route('users.index') }}" class="btn btn-primary waves-light waves-effect">User</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="{{ route('users.create') }}" class="btn btn-icon waves-effect waves-light btn-primary float-right"> <i class="fa fa-plus"></i> </a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-hover table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $r->name }}</td>
                        <td align="center">{{(!(is_null($r->division))? $r->division['name'] : "")}}</td>
                        <td align="center">{{(!(is_null($r->position))? $r->position['name'] : "")}}</td>
                        <td align="center">
                            @foreach ($r->getRoleNames() as $role)
                        ...
                        <td align="center">
                            <a href="{{ route('users.show',$r->id) }}" class="btn btn-icon btn-primary btn-circle"><i
                                    class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="{{ route('users.edit',$r->id) }}" class="btn btn-icon btn-warning btn-circle"><i
                                    class="fa fa-edit" aria-hidden="true"></i></a>
                            <a href="{{ route('users.reset',$r->id) }}" class="btn btn-icon btn-danger btn-circle"><i
