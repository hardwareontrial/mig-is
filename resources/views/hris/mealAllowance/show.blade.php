    ...
    <ul class="list-inline menu-left mb-0">
        ...
        <li>
            <div class="page-title-box">
                <h4 class="page-title">Detail Index Periode </h4>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('MealAllowance.index') }}">Index Periode</a></li>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        @if(Auth::user()->nik!='666')
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <a type="button" href="{{route('MealAllowance.print', $data_master->id)}}" class="btn btn-success float-right" style="background-color:#33AE81" target="_blank">
                                    <i class="fa fa-print"></i> Cetak
                                </a>
                                <a type="button" href="#" class="btn btn-success float-right" style="background-color:#E13102" target="_blank" >
