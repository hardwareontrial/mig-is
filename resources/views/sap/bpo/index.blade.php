...
@section('title','User BPO ')

@section('brand','User BPO')
        ...
        <div class="card-header">            
            <div class="row m-b-10">
                <div class="col-sm-12">
                    ...
                    <a href="{{ route('sap_bpo.index') }}" class="btn btn-primary waves-light waves-effect">BPO</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="{{ route('sap_bpo.create') }}" class="btn btn-sm btn-icon waves-effect waves-light btn-primary float-right"> <i class="fa fa-plus"></i> </a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-hover table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <form action="{{route('sap_bpo.delete', $r->id)}}" method="POST">
                                @csrf
                                <input type="hidden" name="_method" value="PUT">
                                <a href="{{ route('sap_bpo.show', $r->id) }}" 
                                    class="btn btn-sm btn-icon btn-primary btn-circle">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                </a>
                                <a href="{{ route('sap_bpo.edit', $r->id) }}" 
                                    class="btn btn-sm btn-icon btn-warning btn-circle" title="Edit">
                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                </a>                                                        
                                <button type="submit" class="btn btn-sm btn-icon btn-danger btn-circle" 
                                    title="delete" onClick="confirm('Apakah anda ingin menghapus?')">                                    
