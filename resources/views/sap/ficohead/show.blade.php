            ...
            <div class="page-title-box">
                <div class="btn-group float-right">
                    <ol class="breadcrumb hide-phone p-0 m-0">
                        <li class="breadcrumb-item"><a href="{{ route('sap_pro_manag.index') }}">FICO Head</a></li>
                        <li class="breadcrumb-item active">Show FICO Head</li>
                    </ol>
                </div>
    ...
    <div class="card">
        <div class="card-header">        
            <div class="form-inline">                
                ...
                <div class="col-sm-4">
                    <span class="text-md-center"><h4>Show FICO Head</h4></span>
                </div>
                <div class="col-sm-4">
                    <a href="{{ route('sap_fico.edit',$users->id) }}" class="btn btn-sm btn-icon waves-effect waves-light btn-outline-warning float-right"> 
