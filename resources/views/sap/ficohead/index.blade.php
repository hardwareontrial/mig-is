        ...
        <div class="card-header">
            <div class="row m-b-10">
                <div class="col-sm-12">
                    ...
                    <a href="{{ route('sap_fico.index') }}" class="btn btn-primary waves-light waves-effect">FICO Head</a>
            ...
            <table class="table table-hover table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $r->name }}</td>
                        <td align="center">
                            <a href="{{ route('sap_fico.edit',$r->id) }}" 
                                class="btn btn-sm btn-icon btn-warning btn-circle">
                                <i class="fa fa-edit" aria-hidden="true"></i>
                            </a>
                            <a href="{{ route('sap_fico.show',$r->id) }}" 
