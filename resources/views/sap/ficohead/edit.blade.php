                ...
                <div class="btn-group float-right">
                    <ol class="breadcrumb hide-phone p-0 m-0">
                        <li class="breadcrumb-item">
                            <a href="{{ route('sap_fico.index') }}">
                                SAP FICO Head
                            </a>
                        </li>
                        <li class="breadcrumb-item active">Edit FICO Head</li>
                    </ol>
                </div>
    ...
    <div class="card"> 
        <div class="card-header">        
            <div class="form-inline">                
                ...
                <div class="col-sm-4">
                    <span class="text-md-center"><h4>Edit FICO Head</h4></span>
                </div>
            </div>                   
        </div>

        <div class="card-body">            
            <form action="{{ route('sap_fico.update', $users_fico->id) }}" method="POST">
                @csrf
                        ...
                        <div class="input-group">
                            ...
                            <select name="users" id="" class="form-control select2">
                                ...
                                <option value="{{$user->id}}" 
                                    {{($users_fico->user_id == $user->id)?'selected':''}}>
                                    {{$user->name}}
                                </option>
                                @endforeach
                            </select>
                ...
                <div class="form-group row">
                    <div class="col-lg-9 ml-auto">
                        ...
                        <a type="button" class="btn btn-danger" href="{{route('sap_fico.index')}}">
