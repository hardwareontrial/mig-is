        ...
        <div class="card-header">
            <div class="row m-b-10">
                <div class="col-sm-12">
                    ...
                    <a href="{{ route('sap_it.index') }}" class="btn btn-primary waves-light waves-effect">IT</a>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form class="form-inline" action="{{ url()->current() }}" >
                        ...
                        <a href="{{ route('sap_it.index') }}" class="btn btn-sm btn-danger">
                            <i class="fa fa-eraser"></i>
                        </a>
                    </form>
                </div>
                <div class="col-sm-6">
                    <a href="{{ route('sap_it.create') }}" title="create new"
            ...
            <table class="table table-hover table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $r->type }}</td>                   
                        <td align="center">
                            <form action="{{route('sap_it.delete', $r->id)}}" method="POST">                                
                                @csrf
                                <input type="hidden" name="_method" value="PUT">
                                <!-- <a href="" class="btn btn-sm btn-icon btn-primary btn-circle">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                </a> -->
                                <a href="{{ route('sap_it.edit',$r->id) }}" class="btn btn-sm btn-icon btn-warning btn-circle">
