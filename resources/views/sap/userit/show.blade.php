    ...
    <div class="card">
        <div class="card-header">        
            <div class="form-inline">                
                ...
                <div class="col-sm-4">
                    <span class="text-md-center"><h4>Detail SAP User Account</h4></span>
                </div>
                <div class="col-sm-4">
                    <a href="{{ route('sap_users.edit',$SapUser->id) }}" class="btn btn-sm btn-icon waves-effect waves-light btn-outline-warning float-right"> 
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-7">
                    <div class="form-control-plaintext">: {{ $SapUser->username }}</div>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="example-hf-email">
                ...
                <div class="col-lg-7">
                    <div class="form-control-plaintext">: {{ $SapUser->type }}</div>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="example-hf-email">
                ...
                <div class="col-lg-7">
                    <div class="form-control-plaintext">: {{ $bpo->username }}</div>
                </div>
            </div>
        </div>
    </div>
