            ...
            <div class="page-title-box">
                <div class="btn-group float-right">
                    <ol class="breadcrumb hide-phone p-0 m-0">
                        ...
                        <li class="breadcrumb-item active">Request Config SAP</li>
                    </ol>
                </div>
                <h4 class="page-title">Create Config SAP</h4>
            </div>
        </div>
    </div>    
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="fa fa-info" style="width:20px;" title="Masukan detail configuration"></i>
                                        </span>
                                    </div>
                                    <textarea class="form-control" name="sap_config" id="" cols="25" rows="5"></textarea>
                                </div>                                
                            </div>                            
                        </div>
                        <div class="form-group row">
