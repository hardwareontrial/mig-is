            ...
            <div class="card">
                <div class="card-header">
                    <div class="form-inline">
                        ...
                        <div class="col-md-9">
                            <h5 align="center">Show Request Configuration</h5>
                        </div>                            
                    </div>                                                        
                </div>
                <div class="card-body">
                    <form action="{{ route('config.update', $helpdesk->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                ...
                                <div class="col-lg-4">
                                    @if (Auth::user()->id == $approval['bpo_id'])
                                        @if ($approval['bpo_approve'] == null)
                                            <a href="{{ route('config.bpo',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 1]) }}" class="btn btn-success">
                                                <i class="fa fa-check"></i>
                                            </a>
                                            <a href="{{ route('config.bpo',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 0]) }}" class="btn btn-danger"><i class="fa fa-ban"></i></a>
                                        @elseif($approval['bpo_approve'] == '0')
                                            ...
                                            <a href="{{ route('config.cancel',['type' => 'BPO', 'approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id]) }}" class="btn btn-light"><i class="fa fa-close"></i></a>
                                ...
                                <div class="col-lg-4">
                                    @if (Auth::user()->id == $approval['fico_head_id'])
                                        @if ($approval['fico_head_approve'] == null)
                                            ...
                                            @else
                                                <a href="{{ route('config.fico',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 1]) }}" class="btn btn-success">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                                <a href="{{ route('config.fico',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 0]) }}" class="btn btn-danger">
                                                    <i class="fa fa-ban"></i>
                                                </a>
                                            @endif
                                        @elseif($approval['fico_head_approve'] == '0')
                                            <button type="button" class="btn btn-danger" disabled><i class="fa fa-ban"></i> Declined at {{ date('d-M-Y H:i:s',strtotime($approval['fico_head_act_at'])) }}</button>
                                            <a href="{{ route('config.cancel',['type' => 'FICO', 'approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id]) }}" class="btn btn-light"><i class="fa fa-close"></i></a>
                                ...
                                <div class="col-lg-4">
                                    @if(Auth::user()->id == $approval['proman_id'])
                                        @if($approval['proman_approve'] == null) 
                                            ...
                                            @else
                                                <a href="{{ route('config.proman',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 1]) }}" 
                                                    class="btn btn-success">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                                <a href="{{ route('config.proman',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 0]) }}" 
                                        ...
                                        @elseif($approval['proman_approve'] == '1')
                                            ...
                                            <a href="{{ route('config.cancel',['type' => 'proman', 'approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id]) }}" 
                                                class="btn btn-light">
                                                <i class="fa fa-close"></i>
                                            </a>
                                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                @if (Auth::user()->id == $approval['it_id'])
                                    @if ($approval['it_approve'] == null)
                                        ...
                                        @else 
                                            <a href="{{ route('config.it',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 1]) }}" class="btn btn-success">
                                                <i class="fa fa-check"></i>
                                            </a>
                                            <a href="{{ route('config.it',['approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id, 'status' => 0]) }}" class="btn btn-danger">
                                                <i class="fa fa-ban"></i>
                                            </a>
                                        @endif
                                    @elseif($approval['it_approve'] == '0')
                                        ...
                                        <a href="{{ route('config.cancel',['type' => 'IT', 'approval_id' => $approval->id,'helpdesk_id' => $helpdesk->id]) }}" class="btn btn-light"><i class="fa fa-close"></i></a>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">                                    
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="fa fa-info" style="width:20px;"  title="Detail Configuration"></i>
                                            </span>
                                        </div>                                        
                                        <textarea name="sap_config" class="form-control" rows="5">{{ $sap_config->description }}
                                        </textarea>
                                    </div>                                    
                                </div>
                            </div>
