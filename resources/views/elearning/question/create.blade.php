...
<ul class="list-inline menu-left mb-0">
    ...
    <li>
        <div class="page-title-box">
            <h4 class="page-title">Buat Master Soal </h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Buat Master Soal</li>
            </ol>
        </div>
    </li>
                    ...
                    <div class="col-lg-6">
                        <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control" id="example-input1-group1"
                                name="title" value="" placeholder="Masukkan judul master soal" autocomplete="off" required>
                        </div>
                    </div>
                </div>               
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <i class="fa fa-arrow-circle-o-down" style="width:20px;"></i>
                                </span>
                            </div>
                            <input type="number" class="form-control" id="example-input1-group1"
                                name="minimum_score" placeholder="Masukkan nilai minimum" required>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                            ...
                            <input type="number" class="form-control" id="example-input1-group1"
                                name="duration" placeholder="durasi pengerjaan soal" required>
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    Menit
                                </span>
