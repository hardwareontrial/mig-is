...
<ul class="list-inline menu-left mb-0">
    ...
    <li>
        <div class="page-title-box">
            <h4 class="page-title">Buat Master Soal Baru </h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Buat Master Soal Baru</li>
            </ol>
        </div>
    </li>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                            ...
                            <input type="number" class="form-control" id="example-input1-group1"
                                name="duration" placeholder="Masukkan lama durasi pengerjaan soal" required>
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    Menit
                                </span>
