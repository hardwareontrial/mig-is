                ...
                ?>
                    ...
                    <div valign="middle">
                        <td style="vertical-align: middle;">
                            {{ $r->collection['title'] }}
                            <strong>@if (!empty($r->description)) <br> 
                            {{ strtoupper($r->description) }} @endif</strong><br>
                            <em><strong>{{($r->program == '1')?"Ujian": "Remidial"}}</strong></em><br>
                            <small>Dibuat oleh 
                                <b>{{ $r->creator['name'] }}</b>
                            </small>
                        </td>
                        ...
                        <td style="vertical-align: middle;" align="center">
                            <a href="{{ route('schedule.show',['id'=>$r->id,'category'=>'']) }}" 
                                class="btn btn-sm btn-primary btn-circle">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                            </a>
                            @if($uac_update && $current_date_time <= $r->date_start)
                                <a href="{{route('schedule.edit',$r->id)}}" class="btn btn-sm btn-warning">
