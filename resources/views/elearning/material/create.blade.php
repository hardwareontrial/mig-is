...
<ul class="list-inline menu-left mb-0">
    ...
    <li>
        <div class="page-title-box">
            <h4 class="page-title">Buat Materi Baru </h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Buat Materi Baru</li>
            </ol>
        </div>
    </li>
                    ...
                    <div class="col-lg-7">
                        <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control" id="example-input1-group1"
                                name="title" value="" placeholder="Masukkan judul materi" autocomplete="off" required>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                            ...
                            <input type="number" class="form-control" id="example-input1-group1"
                                name="hours" placeholder="Bobot materi" required>
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    Jam
                                </span>
