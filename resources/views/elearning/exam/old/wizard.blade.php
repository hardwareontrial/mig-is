            ...
            @csrf
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <select class="form-control select2" style="width: 40%;" id="select_page" 
                                >
                    ...
                    <div class="col-lg-9 text-right">
                        ...
                        <button class="btn btn-sm btn-icon waves-effect waves-light btn-primary mr-sm-2" id="back_exam"><i class="fa fa-arrow-left"></i> <span class="bold">Kembali</span>
                                    </button>
                        @endif
                        @if ($questions->currentPage() != $questions->total())
                        <button class="btn btn-sm btn-icon waves-effect waves-light btn-primary" id="next_exam"><span class="bold">Berikut <i class="fa fa-arrow-right"></i></span>
                        </button>
                        @endif
                        @if ($questions->currentPage() == $questions->total())
                        <button class="btn btn-sm btn-icon waves-effect waves-light btn-success" id="finish_exam"><span class="bold">Selesai <i class="fa fa-check"></i></span>
                        </button>
                        @endif
                        <button class="btn btn-sm btn-icon waves-effect waves-light btn-success" id="end_exam" hidden><span class="bold">End <i class="fa fa-check"></i></span>
                        </button>
                    </div>
                </div>
            </form>
        ...
        if (isChecked) {
            ...
            $.ajax({
                ...
                success:function(){
                    ...
                    //alert(url.slice(0,sparatorPos) + url.slice(limitPos));
                    //alert(sparatorPos);
                    if (sparatorPos.length == 1){
						window.location.href = url.slice(0,sparatorPos[sparatorPos.length-1]) + url.slice(limitPos);
                    } else {
                    ...
                    //window.location.href = url.slice(0,sparatorPos) + url.slice(limitPos);
                    // alert(sparatorPos);
                    // alert(limitPos);
                    //window.location.href = "{{ $questions->previousPageUrl() }}";
                }
