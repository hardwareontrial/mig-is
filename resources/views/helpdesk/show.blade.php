...
@section('title','Show & Update Helpdesk')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">[{{$helpdesk->id}}] [{{strtoupper($helpdesk->category)}}] - {{$helpdesk->title }}</h4>
                By. {{ $creator->name }}
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="form-inline">
                        ...
                        <div class="col-md-9">
                            <h5 align="center">Update Detail Helpdesk </h5>
                        </div>                        
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="description" class="form-control" 
                                        readonly> {{$helpdesk->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                                        ...
                                        <input type="text" name="date_start" class="form-control" autocomplete="off" 
                                            ...
                                            value="{{ date('m/d/Y',strtotime($helpdesk->date_start)) }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                                        ...
                                        <input name="time_start" type="text" autocomplete="off" 
                                            value="{{ date('H:i',strtotime($helpdesk->date_start)) }}" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                                        ...
                                        <input type="text" name="date_end" class="form-control"  id="datepicker_end"
                                            autocomplete="off" placeholder="mm/dd/yyyy" 
                                            value="{{ date('m/d/Y',strtotime($helpdesk->date_end)) }}"  required>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="input-group mb-2 mr-sm-3 mb-sm-0">
                                        ...
                                        <input id="timepicker_end" name="time_end" type="text" 
                                            ...
                                            value="{{ date('H:i',strtotime($helpdesk->date_end)) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
