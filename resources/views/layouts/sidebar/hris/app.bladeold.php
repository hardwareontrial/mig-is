                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('hris.dashboard') }}" class="{{ Request::url() == url('/hris/dashboard') ? 'active' : '' }}">
                                    <i class="fa fa-dashboard" class=""></i>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('MealAllowance.index')}}" 
                                    class="{{ Request::url() == url('/hris/mealallowance/index') ? 'active' : '' }}">
                            ...
                            <li>
                                <a href="{{ route('MealAllowance.create') }}" class="{{ Request::url() == url('/hris/mealallowance/create') ? 'active' : '' }}">
                                    <i class="fa fa-file-excel-o"></i><span>Data Uang Makan</span>
                                </a>
                            </li>
