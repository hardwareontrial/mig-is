                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('dashboard_edoc.index') }}" class="{{ Request::url() == url('/edoc/dashboard_edoc') ? 'active' : '' }}">
                                    <i class="fi-air-play"></i> <span> Beranda </span>
                                </a>
                            </li>

							@if(Auth::user()->hasAnyPermission([1,7,8]))
                            <li>
                                <a href="{{ route('list.index') }}" class="{{ Request::url() == url('/edoc/schedule') ? 'active' : '' }}">
                                    <i class="fa fi-paper"></i> <span> E-Doc </>
                                </a>
                            </li>
							@endif

                            <li class="menu-title">Master Document ISO</li>

							@if(Auth::user()->hasAnyPermission([1,7,12]))
                            <li>
                                <a href="{{ route('document.index') }}" class="{{ Request::url() == url('/edoc/document') ? 'active' : '' }}">
                                    <i class="fa fa-book"></i> <span> Document </span>
                                </a>
                            </li>
							@endif

                            @if(Auth::user()->hasAnyPermission([1,7,16]))
                            <li>
                                <a href="{{ route('form.index') }}" class="{{ Request::url() == url('/edoc/form') ? 'active' : '' }}">
                                    <i class="fa fa-book"></i> <span> Form </span>
                                </a>
                            </li>
							@endif

                            @if(Auth::user()->hasAnyPermission([1,7,20]))
                            <li>
                                <a href="{{ route('supporting.index') }}" class="{{ Request::url() == url('/edoc/supporting') ? 'active' : '' }}">
                                    <i class="fa fa-book"></i> <span> Supporting </span>
                                </a>
                            </li>
							@endif
