...
Route::group(['middleware' => 'auth'], function() {
	...
	/*-------------Test Function 26/2/21 ---------------------*/
		Route::get('mealallowance/{id}/pdf', [ 'as' => 'mealallowance.printpdf', 'uses' => 'Hris\UangMakanController@printPDF']);
    });
    

    /*---------------------- END TEST FUNCTION 25/2/21 ------------------- 
    Route::group(['prefix' => 'hris', 'middleware' => ['role:Admin|Admin Hris|User Manager|User Supervisor|User Staff|Security Senior Staff|Security Staff']], function(){
        Route::get('mealallowance/index', 'Hris\')
    });
   ------------------------------------------------------------------------*/
});
